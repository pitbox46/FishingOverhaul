...
/**
 * Runs before {@link net.neoforged.neoforge.event.entity.player.ItemFishedEvent}
 */
public class ItemFishedEventPre extends PlayerEvent implements ICancellableEvent {
